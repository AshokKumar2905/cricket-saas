    ...
    <html lang="en" className="scroll-smooth" data-scroll-behavior="smooth">
      ...
      >
        ...
        <div className="fixed inset-0 w-full h-full min-h-screen z-0 pointer-events-none overflow-hidden">
          ...
          <div 
            className="absolute inset-0 w-full h-full bg-cover bg-center bg-no-repeat opacity-[0.15] mix-blend-screen scale-105"
            style={{ 
          ...
          <div className="absolute inset-0 w-full h-full bg-gradient-to-b from-[#030712]/95 via-slate-950/90 to-[#030712]/98 backdrop-blur-[2px]" />
        </div>

        {/* Global Navigation Header Bar Layer */}
        <header className="bg-slate-950/70 border-b border-slate-900 sticky top-0 z-50 backdrop-blur-md shadow-lg shadow-black/20 relative w-full">
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            
            <Link href="/" className="flex items-center gap-3 group relative z-10">
              <div className="p-2 rounded-xl bg-gradient-to-tr from-slate-900 to-emerald-500/10 border border-slate-800 group-hover:border-emerald-500/30 transition-colors shadow-inner">
            ...
            <nav className="flex items-center gap-8 text-xs font-mono font-bold uppercase tracking-wider text-slate-400 relative z-10">
              ...
              {/* FIXED: Changed href from "/app" to "/" to safely point to the main dashboard entry layout */}
              <Link 
                href="/" 
        ...
        <footer className="w-full bg-slate-950/80 py-6 border-t border-slate-900 text-center text-[10px] font-mono text-slate-500 uppercase tracking-widest relative z-10 backdrop-blur-sm">
